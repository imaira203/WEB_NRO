    ...
    <div class="container pt-5 pb-5">
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                ...
                <?php
                $mysqli = new mysqli($ip_sv, $user_sv, $pass_sv, $dbname_sv);
                ...
                if ($_status == '1') {
                    $_alert = '<div class="text-danger pb-2 font-weight-bold">Tài khoản của bạn đã được kích hoạt!<br> Giftcode : nrobando<br> Giftcode : smember<br> Giftcode : member<br> Giftcode : vip888<br> Giftcode : vip999 </div>';
                }
